...
public class TambahKasir extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "INSERT INTO `petugas` (`nama`, `email`, `username`, `password`, `tgl_pendaftaran`) VALUES('" + nama + "', '" + email + "', '" + username + "', '" + password + "', current_timestamp())";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahKasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TambahKasir().setVisible(true);
            }
        });
    }
